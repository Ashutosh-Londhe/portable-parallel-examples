...
This repository demonstrates how to port the Laplace2D Fortran program to SYCL and run it on Intel, AMD, and NVIDIA GPUs.
...
Attempting to link with ifx results in an error:
